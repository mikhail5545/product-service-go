...
var (
	...
	// ErrNotFound course or it's product not found error
	...
	// ErrImageNotFoundOnOwner can't find image on course error
	ErrImageNotFoundOnOwner = errors.New("image not found on course")
)
