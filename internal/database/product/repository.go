...
type Repository interface {
	...
	ListByType(ctx context.Context, productType string, limit, offset int) ([]models.Product, error)
	Count(ctx context.Context) (int64, error)
	CountByType(ctx context.Context, productType string) (int64, error)

	// Write operations
	Create(ctx context.Context, product *models.Product) error
	Update(ctx context.Context, product *models.Product, updates any) (int64, error)
...
func (r *gormRepository) Get(ctx context.Context, id string) (*models.Product, error) {
	var product models.Product
	err := r.db.WithContext(ctx).First(&product, id).Error
	return &product, err
}

func (r *gormRepository) List(ctx context.Context, limit, offset int) ([]models.Product, error) {
	var products []models.Product
	err := r.db.WithContext(ctx).Limit(limit).Offset(offset).Order("created_at desc").Find(&products).Error
	return products, err
}

func (r *gormRepository) ListByType(ctx context.Context, productType string, limit, offset int) ([]models.Product, error) {
	var products []models.Product
...
func (r *gormRepository) CountByType(ctx context.Context, productType string) (int64, error) {
	var count int64
...
func (r *gormRepository) Update(ctx context.Context, product *models.Product, updates any) (int64, error) {
